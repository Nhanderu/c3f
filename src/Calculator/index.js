        ...
        <View style={styles.panelsArea}>
          <View style={dynamicStyles.panelA}>
            <View style={styles.column}>
              <LabeledInput value={values.a1} onChangeText={updateValues('a1')}>
                Segunda
              </LabeledInput>
              <LabeledInput value={values.a2} onChangeText={updateValues('a2')}>
                Terça
              </LabeledInput>
              <LabeledInput value={values.a3} onChangeText={updateValues('a3')}>
                Quarta
              </LabeledInput>
              <LabeledInput value={values.a4} onChangeText={updateValues('a4')}>
                Quinta
              </LabeledInput>
              <LabeledInput value={values.a5} onChangeText={updateValues('a5')}>
                Sexta
              </LabeledInput>
              <LabeledInput value={values.a6} onChangeText={updateValues('a6')}>
                Sábado
              </LabeledInput>
              <LabeledInput value={values.a0} onChangeText={updateValues('a0')}>
                Domingo
              </LabeledInput>
            </View>
          </View>
          ...
          <View style={dynamicStyles.panelC}>
            <View style={styles.column}>
              <LabeledInput value={values.c0} onChangeText={updateValues('c0')}>
                Janeiro
              </LabeledInput>
              <LabeledInput value={values.c1} onChangeText={updateValues('c1')}>
                Fevereiro
              </LabeledInput>
              <LabeledInput value={values.c2} onChangeText={updateValues('c2')}>
                Março
              </LabeledInput>
              <LabeledInput value={values.c3} onChangeText={updateValues('c3')}>
                Abril
              </LabeledInput>
              <LabeledInput value={values.c4} onChangeText={updateValues('c4')}>
                Maio
              </LabeledInput>
              <LabeledInput value={values.c5} onChangeText={updateValues('c5')}>
                Junho
              </LabeledInput>
              <LabeledInput value={values.c6} onChangeText={updateValues('c6')}>
                Julho
              </LabeledInput>
              <LabeledInput value={values.c7} onChangeText={updateValues('c7')}>
                Agosto
              </LabeledInput>
              <LabeledInput value={values.c8} onChangeText={updateValues('c8')}>
                Setembro
              </LabeledInput>
              <LabeledInput value={values.c9} onChangeText={updateValues('c9')}>
                Outubro
              </LabeledInput>
              <LabeledInput
                value={values.c10}
